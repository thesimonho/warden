...
- **Windows** — Inno Setup installer (`warden-desktop-setup-windows-amd64.exe`) with optional PATH integration. Built with `-H windowsgui` and icon embedding via `goversioninfo`
