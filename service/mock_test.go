...
func (m *mockEngine) CheckContainerName(_ context.Context, _ string) api.CheckNameResult {
...
func (m *mockEngine) ContainerIP(_ context.Context, _ string) (string, error) {
...
func (m *mockEngine) ResetWorktree(_ context.Context, _, _ string) error {
	return nil
}
