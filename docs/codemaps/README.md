...
| --- | --- | --- |
| [supporting.md](backend/supporting.md) | Entry points, binaries, access items, agent provider, runtime detection, terminal proxy | `warden`, `cmd/`, `access/`, `agent/`, `runtime/`, `internal/terminal/` |
