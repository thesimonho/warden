...
| File                   | Purpose                                                                                                                                                                                                                                                   |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `status_dot.go`        | Maps `WorktreeState`, `NotificationType`, and container state to styled unicode dot characters. Exports `FormatStatusDot()` function. Defines state→color mapping (connected=green, shell=amber, background=purple, stopped=gray, working=pulsing, etc.). |
