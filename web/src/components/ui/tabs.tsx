...
const tabsListVariants = cva(
  [
    // Layout
    'group/tabs-list inline-flex w-fit items-center justify-center rounded p-[3px]',
    // Typography
...
function TabsTrigger({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Trigger>) {
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // Layout
        'relative inline-flex h-[calc(100%-1px)] flex-1 cursor-pointer',
        ...
        'dark:data-[state=active]:border-border dark:data-[state=active]:bg-background',
        'dark:data-[state=active]:text-foreground',
        // Default variant active shadow
        ...
        // Active underline indicator (::after pseudo-element)
